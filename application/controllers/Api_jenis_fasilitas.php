...
class Api_jenis_fasilitas extends \Restserver\Libraries\REST_Controller
{
...
// constructor
    public function __construct($config = 'rest')
    {
        ...
        $this->load->model('Fasilitas_jenis_model');
    ...
    public function index_get()
    {
        ...
        $data = $this->Fasilitas_jenis_model->get_All();
        $this->response(
            ['msg_main' => [
                'status' => true,
    ...
    {
        $id = $this->post('id');
        $data = $this->Fasilitas_jenis_model->get_byId($id);
        $this->response(
            ['msg_main' => [
                'status' => true,
                'msg' => "get data success",
    ...
    {
        $data = $this->Fasilitas_jenis_model->ket_jenis_get();
        $this->response(
            ['msg_main' => [
                'status' => true,
                'msg' => "get data success!",
    ...
    public function index_post()
    {
        ...
        $id = $this->Fasilitas_jenis_model->get_id();
        ...
        // $query = $this->Fasilitas_jenis_model->post_All($data);
    ...
    public function update_post()
    {
        ...
        if ($is_valid) {
            ...
            if (!$this->upload->do_upload('img')) {
                ...
                $query = $this->Fasilitas_jenis_model->update_byId($id_jenis, $data);
                $error_upload = array('img' => $this->upload->display_errors());
    ...
    {
        $id = $this->delete('id');
        $query = $this->Fasilitas_jenis_model->delete_byId($id);
        if ($query === true) {
            $this->response(
                ['msg_main' => [
                    'status' => true,

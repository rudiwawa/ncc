...
<body background="bg-light align-items-center">
    ...
    <div class="py-0 p-3">
        <b style="font-size: 20pt">Login</b><br />
        <p>Silahkan login pada halaman di bawah ini: </p>
        <div class="background">
            ...
            <br/><p>Silahkan melakukan <a href="<?php echo site_url('cRegister/index'); ?>">registrasi</a> di bawah ini, bila belum terdaftar menjadi admin.</p>
        </div>
    </div>
